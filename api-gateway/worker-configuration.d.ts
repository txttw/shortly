/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c0aa687f3eda84ece89296a272db9885)
...
declare namespace Cloudflare {
	interface Env {
		...
		SERVICE_ORIGINS: {"users":"shortly-users.tamas-munka.workers.dev","links":"shortly-links.tamas-munka.workers.dev","analytics":"shortly-analytics.tamas-munka.workers.dev"};
		SIGN_KEY: string;
		DATABASE_URL: string;
		SERVICE_USERS: Fetcher;
		SERVICE_LINKS: Fetcher;
		SERVICE_ANALYTICS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_ORIGINS" | "SIGN_KEY" | "DATABASE_URL">> {}
}
