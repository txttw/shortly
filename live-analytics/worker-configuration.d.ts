/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 398eaf643df7e88abb57819c722934f9)
// Runtime types generated with workerd@1.20250428.0 2025-05-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SIGN_KEY: string;
		LA_WEBSOCKET_SERVER: DurableObjectNamespace<import("./src/index").LiveAnalytics>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIGN_KEY">> {}
}
